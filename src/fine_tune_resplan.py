...
best_model_path = SAVE_DIR / "resplan_" /f"mitunet_{ENCODER_NAME}_multiclass_best.pth"
best_metadata_path = SAVE_DIR / "resplan_" /f"mitunet_{ENCODER_NAME}_multiclass_best.json"
best_iou = -1.0
history = []
